...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string userid = Request.Form.Get("username").Trim();
        string pwd = Request.Form.Get("pwd").Trim();
        string checkcode = Request.Form.Get("checkcode").Trim();


        if (checkcode.ToUpper() != Session["checkcode"].ToString().ToUpper())
        {
            Session["checkcode"] = "";
			db.closedb();
            //Response.Write("<br><font size='2'>　验证码错误,<a href='" + Link.url("/", "default.aspx","","","","","") + "'>返回</a></font>");
            Fun.alert("","验证码错误！",Link.url("/", "default.aspx","","","","","") ,"返回");
            Response.End();
    ...
    protected void SetLoginLog(DBClass db)
    {
        ...
        param[0].Value = HttpContext.Current.Request.ServerVariables["HTTP_REFERER"].ToString();
