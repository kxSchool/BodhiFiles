   ...
   protected void Page_Load(object sender, EventArgs e)
    {
		...
		sqls = "select * from tbexcel where id=" + sid;
        popedomgrouptable = db.GetTable(sqls, null);
		fileurl=popedomgrouptable.Rows[0]["fileurl"].ToString();

        DataTable dt = db.GetTable("select filetitle from  tbexcel where fileurl='" + fileurl + "'", null);
        if (dt.Rows.Count > 0)
        {
        ...
        {
			  Fun.alert("","没有该文件，可能已经被删除！",Link.url("/app_mgr/excel_mgr/","excel_recycle.aspx","","","","","") ,"返回");
            Page.Response.End();
        }
        ...
        full_fileurl = ConfigurationSettings.AppSettings["excel_center"].ToString()+"删除统计表/" + fileurl;
