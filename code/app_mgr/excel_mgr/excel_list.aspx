...
<script runat="server">
    ...
    protected void ShowPage(DBClass db)
    {
        ...
        for (int i = (nowpage - 1) * pagesize; i < showcount; i++)
        {
            ...
            sb.Append("<td height=\"24\" align=\"center\" ><a href=\""+Link.url("/app_mgr/excel_mgr/","excel_form_pageupdate.aspx",datatable.Rows[i]["id"].ToString(),"","","","") + "\">管理记录</a></td>");
            sb.Append("<td height=\"24\" align=\"center\" ><a href=\""+Link.url("/app_mgr/excel_mgr/","excel_form.aspx",datatable.Rows[i]["id"].ToString(),"","","","") + "\">在线填报</a></td>");
            sb.Append("</tr>\n");
...
<myhead:myhead ID="Myhead1" runat="server" />
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1"  class="lvt small">
     <form action="<%= Link.url("/app_mgr/excel_mgr/","excel_list.aspx","","set","","","") %>" method="post" name="selform" > <tr class="lvtCol">
       ...
       <tr bgcolor="white" onMouseOver="this.className='lvtColDataHover'" onMouseOut="this.className='lvtColData'">
           <td align="center" colspan="11" height="35" class="but1" style="width: 100%;">
               ...
               页，每页
               <%=pagesize%>
               个&nbsp; <a href="<%=Link.url("/app_mgr/excel_mgr/","excel_list.aspx","1","","","","") %>">
                   首页</a> <a href="<%=Link.url("/app_mgr/excel_mgr/","excel_list.aspx",(nowpage-1).ToString(),"","","","") %>">
                       上一页</a> &nbsp;<a href="<%=Link.url("/app_mgr/excel_mgr/","excel_list.aspx",(nowpage+1).ToString(),"","","","") %>">下一页</a>&nbsp;
               <a href="<%=Link.url("/app_mgr/excel_mgr/","excel_list.aspx",maxpage.ToString(),"","","","") %>">
                   尾页</a></td>
      </tr></form>
  </table>
