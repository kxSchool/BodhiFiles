...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
		 db.closedb();
         Fun.alert("","你没有输入查询条件！",Link.url("/app_mgr/news_mgr/","data_all.aspx","","","","","") ,"返回");
    ...
    void ShowPage(DBClass db)
    {
        ...
        sqls = " select tbdata.*,tbuser.userno,username from tbdata left join tbuser on  tbdata.userno=tbuser.userno where ( tbdata.filetitle like '%" + condition + "%' or description like '%" +
           condition + "%' or username like '%" + condition + "%'  ) order by tbdata.uptime desc";
    ...
    <td class=small nowrap><table>
      <tr>
        <td align="left" valign="middle" class="small" style="height: 16px">
                              单位资料搜索结果 <span class="txtGreen">"<%= condition %>"</span> 
                              </td>
        </tr>
    </table> </td>
  </tr>
...
<td >
 			...
 			<form action="<%= Link.url("/app_mgr/ziliao_mgr/","data_adminsearch.aspx","","set","","","")%>" method="post" name="selform" >
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="lvt small">
      ...
      共  <%=total%> 个资料，当前第 &nbsp;<font color="red"><%=nowpage%></font>/   <%=maxpage%>
            ...
            页，每页 
          <%=pagesize%>个&nbsp; <a href="<%= Link.url("/app_mgr/ziliao_mgr/","data_adminsearch.aspx","1","search",HttpUtility.UrlEncode(condition, System.Text.Encoding.UTF8),"","") %>">首页</a> <a href="<%= Link.url("/app_mgr/ziliao_mgr/","data_adminsearch.aspx",(nowpage-1).ToString(),"search",HttpUtility.UrlEncode(condition, System.Text.Encoding.UTF8),"","") %>">上一页</a> &nbsp;<a href="<%= Link.url("/app_mgr/ziliao_mgr/","data_adminsearch.aspx",(nowpage+1).ToString(),"search",HttpUtility.UrlEncode(condition, System.Text.Encoding.UTF8),"","") %>">下一页</a>&nbsp;
          <a href="<%= Link.url("/app_mgr/ziliao_mgr/","data_adminsearch.aspx",maxpage.ToString(),"search",HttpUtility.UrlEncode(condition, System.Text.Encoding.UTF8),"","") %>">尾页</a></td>
