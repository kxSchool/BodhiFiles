...
db.closedb();
	  ...
	  protected void SetLoginLog(DBClass db)
      {
        OdbcParameter[] param ={
          ...
          new OdbcParameter("@browser",OdbcType.VarChar,255),
		  new OdbcParameter("@os",OdbcType.VarChar,255)
        };
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
      ...
      <tr>
        <td align="left" valign="middle" bgcolor="#FFFFFF"  style="width: 845px; height: 26px"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="<%= Link.url("/app_mgr/news_mgr/","newsbbs_log.aspx",Request.QueryString["param1"].ToString(),"","","","") %>">
			  <img src="/images/newsbbs.jpg" alt="" width="95" height="24" style="border:0;" /></a>
                 <a href="<%= Link.url("/app_mgr/news_mgr/","news_log.aspx",Request.QueryString["param1"].ToString(),"","","","") %>"><img src="/images/newslog.jpg" alt="" width="95" height="24" border="0" style="border:0;" /></a> <a class="redword" onClick="initialize(1,'1',event);ShowHide('1',null);return false;"><img src="/images/addnewsbbs.jpg" alt="" width="95" height="24" style="border:0;" /></a></td>
            </tr>
        </table></td>
      </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1"  class="lvt small">
      ...
      共 <%=total%> 个资料，当前第 &nbsp;<font color="red"><%=nowpage%></font>/ <%=maxpage%> 页，每页 <%=pagesize%> 个&nbsp; <a href="<%=Link.url("/app_mgr/news_mgr/","news_view.aspx",news_id,"1","","","") %>"> 首页</a> <a href="<%=Link.url("/app_mgr/news_mgr/","news_view.aspx",news_id,(nowpage-1).ToString(),"","","") %>"> 上一页</a> &nbsp;<a href="<%=Link.url("/app_mgr/news_mgr/","news_view.aspx",news_id,(nowpage+1).ToString(),"","","") %>">下一页</a>&nbsp; <a href="<%=Link.url("/app_mgr/news_mgr/","news_view.aspx",news_id,maxpage.ToString(),"","","") %>"> 尾页</a></td>
      </tr>
    </table></td>
  </tr>
</table>
