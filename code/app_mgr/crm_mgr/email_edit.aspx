...
<script runat="server">
    ...
    protected string mailtitle = "",mailcontent="";
...
if (Request.QueryString["param2"] == null || Request.QueryString["param2"] == "")
        {
			DataTable dt = db.GetTable("select * from tbmail_ad where id=1");
                if (dt.Rows.Count > 0)
                {
		 ...
		 if (Request.QueryString["param2"].ToString() == "saveedit")
            {
                ...
                string updatesql = "update tbmail_ad set mailtitle=?,mailcontent=? where id=1";
                OdbcParameter[] param ={ 
                   new OdbcParameter("@mailtitle",OdbcType.VarChar,255),
				   new OdbcParameter("@mailcontent",OdbcType.Text) 
                };
				
                param[0].Value = Request.Form.Get("mailtitle").ToString();
				param[1].Value = sb.ToString();  
                 db.ExecuteNonQuery(updatesql, param);
				 
				 
                db.closedb();
			    Fun.alert("","修改信息成功！",Link.url("/app_mgr/crm_mgr/","email_edit.aspx","","","","","") ,"返回");
...
<myhead:myhead ID="Myhead1" runat="server" /> <div>
  ...
  <tr>
    ...
    <td width="150" align="left" nowrap class=small><table>
        <tr>
          <td> <b><font color="#ffffff">群发广告邮件修改</font></b></td>
        </tr>
    </table></td>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="850" align="center"><table border="0" align="center" style="width: 689px">
          <tr>
            <td width="90" style="height: 27px">&nbsp; </td>
          ...
          <tr>
            ...
            <td  style="height: 27px;">
              <input type="text" id="mailtitle" name="mailtitle" value="<%= mailtitle %>"  style="width: 300px;height:20px"/>
            </td>
          </tr>
          <tr>
...
output(dt,a);
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    <td style="border:1px solid #81a9ce;border-top:0;background:#fff;">
                      <IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:400px;width:100%;background:#fff;" frameBorder="0" marginHeight=0 marginWidth=0 src="<%=Link.url("/htmleditor/","email.aspx","1","","","","")%>"  onload="SetDiv();"></IFRAME>
 ...
 function submitcontent()
 {
   ...
   if(document.form1.mailtitle.value==""){window.alert("邮件名称不能为空！");document.form1.mailtitle.focus();return (false);}
	...
	document.form1.action="<%=Link.url("/app_mgr/crm_mgr/","email_edit.aspx","","saveedit","","","") %>"
