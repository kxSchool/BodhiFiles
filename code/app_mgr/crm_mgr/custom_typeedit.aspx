...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["param2"] == null || Request.QueryString["param2"] =="")
        {
            if (Request.QueryString["param1"] != null)
            {
                ...
                DataTable nt = db.GetTable("select typename from tbcustomtype where id=?", p);
    ...
    protected void SaveEdit(DBClass db)
    {
        ...
        string sql = "update tbcustomtype set typename=? where id=?";
        OdbcParameter[] param ={ 
        ...
        param[1].Value = Convert.ToInt32(Request.Form.Get("editid").ToString());
...
<myhead:myhead ID="Myhead1" runat="server" />
 ...
 <div>
    <form name="form1" method="post" action="<%= Link.url("/app_mgr/crm_mgr/","custom_typeedit.aspx","","saveedit","","","") %>" onsubmit ="return form_check();">
