...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Request.QueryString["param2"].ToString() == "addnewsbbs")
            {
                ...
                param[4].Value =0;
                db.ExecuteNonQuery("insert into tbnewsbbs (news_id,userno,content,createtime,isdelete)values(?,?,?,?,?)", param);
                db.closedb();
...
var dd=GetContents();
	...
	document.form1.action="<%= Link.url("/app_mgr/news_mgr/","newsbbs_add.aspx",Request.QueryString["param1"].ToString(),"addnewsbbs","","","") %>"
