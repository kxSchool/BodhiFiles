...
<script runat="server" language="C#">
    ...
    protected void DeleteData(DBClass db)
    {
        ...
        for (int i = 0; i < setfilestable.Rows.Count; i++)
        {
          ...
          db.closedb();
		  Fun.alert("","成功删除至回收站！",Link.url("/app_mgr/excel_mgr/","excel_mgr.aspx","","","","","") ,"返回");
...
<myhead:myhead ID="Myhead1" runat="server" />
  ...
  <tr>
    ...
    <td nowrap class=small style="width: 100px"><table>
        <tr>
          <td> <b><font color="#ffffff">统计管理</font></b></td>
        </tr>
    </table></td>
      ...
      <tr>
        <td height="32" class=small>
                               <input type="text" name="param3" style="width: 186px; height: 20px;" />
                                         <input type="button" value="查找" onClick="javascript:document.selform2.submit()" style="width: 75px; height: 21px;" /></td>
        </tr>
    </table> </td>
  </tr>
</TABLE>
