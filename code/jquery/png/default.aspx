...
<html>
	<head>
		...
		<title>逼真的jquery鼠标滑过效果</title>
		<meta name="author" content="Adrian Pelletier" />
		<link rel="stylesheet" type="text/css" href="images/screen.css" media="all" />
		<script type="text/javascript" src="images/jquery-1.3.2.min.js"></script>
		<script type="text/javascript" src="images/jquery-ui-1.7.1.custom.min.js"></script>
		<script type="text/javascript" src="images/execute.js"></script>
	</head>
<body>
<div id="content">
	<h1>分享到：</h1>
